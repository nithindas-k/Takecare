    ...
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (response?.success && response?.data?.token && response?.data?.user) {
          ...
          setTimeout(() => navigate("/doctor/verification"), 1500);
        } else {
          ...
          <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-white via-gray-50/50 to-teal-50/30 border-r border-gray-100">
            ...
            >
              ...
              <p className="text-gray-500 text-sm max-w-xs leading-relaxed">
                Doctor, please enter the security code sent to your email to verify your professional account.
              </p>
            </div>
          </div>
          ...
          >
            <div className="w-full max-w-md">
              <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-8 lg:p-10 border border-gray-100">
                ...
                {(serverMessage || errors.otp) && (
                  <div className={`text-sm mb-6 p-4 rounded-xl border ${serverMessage.includes("successful") || serverMessage.includes("sent")
