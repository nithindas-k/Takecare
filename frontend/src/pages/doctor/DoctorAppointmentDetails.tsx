                                            ...
                                            <div className="w-full flex flex-col gap-3">
                                                {!appointment?.postConsultationChatWindow?.isActive && !appointment?.TEST_NEEDED ? (
                                                    ...
                                                    <div className="w-full flex flex-col gap-2">
                                                        <Button onClick={() => navigate(`/doctor/${normalized.appointmentType === 'video' ? 'call' : 'chat'}/${normalized.id}`)} className="w-full px-6 py-2.5 bg-[#00A1B0] hover:bg-[#008f9c] text-white font-semibold rounded-lg transition-colors shadow-sm flex items-center justify-center gap-2"><MessagesSquare className="h-4 w-4" />Go to Chat</Button>
