    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4 pt-24">
      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:flex justify-center lg:justify-end">
          <img src="/doctor.png" alt="Doctors Illustration" className="w-full max-w-lg object-contain" />
        </div>
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="bg-white rounded-2xl shadow-xl p-10">
            ...
            <div className="text-center mt-6">
              ...
              <Link to="/doctor/login" className="text-primary hover:text-primary/80 font-medium hover:underline">Login</Link>
            </div>
          </div>
        </div>
      </div>
