        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10">
            <div className="flex items-start justify-between mb-8">
              ...
              <Link to="/doctor/login" className="text-teal-500 hover:text-teal-600 font-medium text-sm whitespace-nowrap ml-4">
                Are you a Doctor?
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-5" aria-describedby="formErrors">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="text-sm text-teal-500 hover:text-teal-600 font-medium hover:underline"
                  >
                    Forgot Password?
                  </button>
                </div>
              ...
              <div className="text-center mt-6">
                ...
                <Link to="/patient/register" className="text-teal-500 hover:text-teal-600 font-medium hover:underline">
                  Register
                </Link>
              </div>
            </form>
