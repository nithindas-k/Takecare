...
const DoctorForgotPasswordOTP: React.FC = () => {
  ...
  const [timeLeft, setTimeLeft] = useState(RESEND_OTP_INTERVAL);
  ...
  const handleResend = useCallback(async () => {
    try {
      ...
      if (response.success) {
        setTimeLeft(RESEND_OTP_INTERVAL);
          ...
          <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-white via-gray-50/50 to-teal-50/30 border-r border-gray-100">
            ...
            >
              ...
              <p className="text-gray-500 text-sm max-w-xs leading-relaxed">
                Doctor, please enter the security code we sent to your inbox to continue resetting your professional account password safely.
              </p>
            </div>
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="text-center">
                    <button
                      ...
                      className={`text-sm font-medium ${timeLeft > 0 ? "text-gray-400" : "text-[#00A1B0] hover:text-teal-600"
                        }`}
                    >
