      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 flex pt-20">
          ...
          <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-white via-gray-50/50 to-teal-50/30 border-r border-gray-100">
            ...
            <div
              className="absolute bottom-[22%] left-0 right-0 flex flex-col items-center gap-3 px-8"
            ...
            >
              ...
              <p className="text-gray-500 text-sm text-center max-w-xs leading-relaxed">
                Doctor, please choose a secure password to protect your professional account and patient data.
              </p>
            </div>
          </div>
          ...
          >
            <div className="w-full max-w-md my-auto">
              <div className="bg-white rounded-2xl shadow-xl shadow-teal-900/10 p-8 lg:p-10 border border-gray-100">
                <div className="mb-8">
                  <h1 className="text-3xl font-bold text-gray-800 mb-2">Reset Password</h1>
                  <p className="text-gray-600 text-sm">Enter your new professional password</p>
                </div>
