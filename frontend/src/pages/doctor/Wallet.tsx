                ...
                <div className="space-y-6">
                    ...
                    {!loading && hasReversals && (
                        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-bold text-amber-800">Earnings Reversal Notice</p>
                                <p className="text-xs text-amber-700 mt-0.5">Some consultation fees were reversed due to patient cancellations or no-show sessions. These deductions were applied according to the cancellation policy.</p>
                            </div>
                        </div>
                    )}
